...
%  Detection Error Tradeoff (DET) curve for the given set LABELS and
%  SCORES. The function is a simple wrapper to VL_ROC(LABELS,
%  SCORES). In fact, MISSRATE is simply 1-TN and FALSEARALM is 1-TP,
%  where TP is the true positive rate and TN the true negative rate as
%  returned by VL_ROC().
%
...
%    performance. In Proc. Conf. on Speech Communication and
%    Technology, 1997.
