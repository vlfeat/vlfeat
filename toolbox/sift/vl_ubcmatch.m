% VL_UBCMATCH  Match VL_SIFT features
%   MATCHES = VL_UBCMATCH(DESCR1, DESCR2) matches the two sets of VL_SIFT
...
%
%   VL_UBCMATCH(DESCR1, DESCR2, THRESH) uses [1] with the specified
