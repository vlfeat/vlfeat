function [H,details] = harris(I,si,alpha)
% HARRIS  Harris corner strength
%  H = HARRIS(I,SI) computes the Harris corner strength of the image I
...
%  its gradient. SI and SD are independent parameters and HARRIS(I,SI)
