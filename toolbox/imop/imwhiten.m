...
%   J = IMWHITEN(I,ALPHA) approximatively whitens the power spectrum
%   of the natural image I. The algorithm assumes that the modulus of
%   the spectrum decays as 1/f^ALPHA (f is the frequency).
%
%   IMWHITEN(I) uses ALPHA=1 (a typical value for natural images).
%
%   IMWHITEN(I,ALPHA,CUTOFF) also applies a low-pass filter with
