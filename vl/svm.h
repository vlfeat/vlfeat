...
VL_EXPORT double vl_svm_hinge_conjugate_loss (double label, double alpha) ;
VL_EXPORT double vl_svm_hinge_dca_update (double inner, double norm2, double label, double alpha) ;
