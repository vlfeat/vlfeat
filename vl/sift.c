 ...
 **
 ** @subsection sift-detector-peak Peak treshold
 **
 ...
 ** the peak with the <b>peak treshold</b> @f$t_p@f$ and discarding
 ** the peak this value is below the treshold.
 **
 ** @subsection sift-detector-edge Edge treshold
 **
 ...
 ** treshold</b>. Notice that this quantity has a minimum equal to 4
 ** when @f$t_e=1@f$ and grows thereafter. Therefore the range of the
 ** edge treshold is @f$[1,\infty)@f$.
 **
